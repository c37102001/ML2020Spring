...
img_dataset = ImageFolder('pattern_imgs', transform=train_transform)
...
if args.plot_recon or args.plot_all:
    ...
    img_dataset = ImageFolder('pattern_imgs', transform=test_transform)     # len=2425
    img_dataloader = DataLoader(img_dataset, batch_size=6, shuffle=True)
    
    imgs_tensor, _ = next(iter(img_dataloader))         # (b, 3, 32, 32)    (B, C, H, W)
